...
export const meta: Route.MetaFunction = () => {
  return [
    { title: "Notifications | MarketFlow" },
    {
      name: "description",
      content:
        "Consultez vos alertes de commande et les mises à jour importantes de votre compte MarketFlow.",
    },
    { property: "og:title", content: "Notifications | MarketFlow" },
    {
      property: "og:description",
      content:
        "Recevez les notifications de vos commandes et suivez l'évolution de votre activité d'achat.",
    },
